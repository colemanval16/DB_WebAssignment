                    ...
                    <asp:MultiView ID="mvTabs2" runat="server" ActiveViewIndex="0">
                        ...
                        <asp:View ID="View2" runat="server">
                            ...
                            <p>Microsoft SQL Server includes a wide range of predefined data types called built-in data
                                types. Most of the databases you will create or use employ only these types of data. Microsoft 
                                SQL Server 2008’s built-in data types are organized into the following general categories:</p>
                            <ul>
                                <li>Exact numbers</li>
                            ...
                            <ul>
                                ...
                                <li>A <strong>graphical designer</strong> is an application, such as Microsoft Access, that is 
                                    object-oriented and drag-and-drop driven.</li>  
                            ...
                            <ul>
                                ...
                                <li><strong>User-defined functions</strong> are compact segments of user-written SQL code that can accept 
                                    parameters and return either a value or a table.</li>      
                        ...
                        <asp:View ID="View3" runat="server">
                            ...
                            <p>FROM employees</p>
                            <p>WHERE department = ‘shipping’ AND gender = ‘F’ AND hired >= ‘2000-JAN-01’</p>
                            ...
                            <p>The function of the UPDATE statement is to change data in a table or view. Much like any of the data 
                                manipulation or modification clauses and statements within SQL, you can use this statement in either 
                                SSMS or a text editor window</p>
                            <p>The UPDATE clause allows you to modify data stored in tables using data attributes such as the following:</p>
                        ...
                        <asp:View ID="View4" runat="server">
                            ...
                            <p>Normalization is the elimination of redundant data to save space.The main reason for using 
                                normalization techniques in data storage arose in the days when storage cost a great deal 
                                more than it does today. Indeed, normalization, in a nutshell, is the elimination of 
                                redundant data to save space.</p>
                            ...
                            <ul>
                                <li>A <strong>primary key</strong> serves as the unique identifier of a specific row and uniquely 
                                    defines a relationship within a database.</li>
                                <li>A <strong>foreign key</strong> references the primary key in another table.</li>
                                <li><strong>Data integrity</strong> ensures that data is consistent, correct, and usable throughout 
                                    the database.</li>
                            </ul>
                            ...
                            <ul>
                                <li>An <strong>index</strong> contains keywords and associated data that point to the location of more 
                                    comprehensive information, such as files and records on a disk or record keys in a database.</li>
                                <li>In a <strong>b-tree</strong> structure for storing database indexes, each node in the tree contains 
                                    a sorted list of key values and links that correspond to ranges of key values between the listed values.</li>
                                <li>A <strong>non-clustered index</strong> is arranged similarly to the index of a book, where the index 
                                    value points to the actual information.</li>
                                <li>A <strong>clustered index</strong> is arranged in a special order to make retrieval of information 
                                    faster with direct access to the information.</li>
                            </ul>
                        </asp:View>
                        <asp:View ID="View5" runat="server">
                            ...
                            <p>When you perform backups, you can choose the type of backup that is best for your environment.
                                The type of backup is based on simplicity, time to perform a backup, and time to perform a restore.</p>
                            <ul>
